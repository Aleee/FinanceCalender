...
class SettingsDialog(QDialog):
    ...
    def __init__(self, settings_handler: SettingsHandler, parent=None):
        ...
        palette = self.ui.lw_menu.palette()
    ...
    def change_path(self, le_widget: QLineEdit):
    ...
    def change_stw_page(self, current_item: QListWidgetItem, previous_item: QListWidgetItem):
