...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.act_finplan.setEnabled(False)
        icon9 = QIcon()
        ...
        self.act_fulfillment.setEnabled(False)
        icon10 = QIcon()
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 200, 679))
