...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icon-toolbar/designer/icons/settings.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_settings.setIcon(icon)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icon-toolbar/designer/icons/itemtop.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_toggleheaders.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icon-toolbar/designer/icons/itembottom.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_togglefooters.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icon-toolbar/designer/icons/new.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_new.setIcon(icon3)
        self.act_new.setMenuRole(QAction.MenuRole.NoRole)
        self.act_edit = QAction(MainWindow)
        self.act_edit.setObjectName(u"act_edit")
        icon4 = QIcon()
        icon4.addFile(u":/icon-toolbar/designer/icons/edit.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_edit.setIcon(icon4)
        self.act_edit.setMenuRole(QAction.MenuRole.NoRole)
        self.act_delete = QAction(MainWindow)
        self.act_delete.setObjectName(u"act_delete")
        icon5 = QIcon()
        icon5.addFile(u":/icon-toolbar/designer/icons/delete.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_delete.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icon-toolbar/designer/icons/copy.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_copy.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icon-toolbar/designer/icons/export.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_export.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icon-toolbar/designer/icons/financing.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.act_finplan.setIcon(icon8)
